...
interface ColorHsl
{
    ...
    s : number; // min:0.0, max:calcSaturation({r:1.0, g:0.0, b:0.0})
...
const calcSaturation = (expression : ColorRgb) : number => {
    //const lightness = xyzToLength(rgbToXyz(expression)) / xyzToLength({x:1.0, y:1.0, z:1.0});
    const lightness = Math.sqrt(Math.pow(xyzToLength(rgbToXyz(expression)), 2) /3);
...
const hslToRgb = (expression : ColorHsl) : ColorRgb => {
    ...
    return pass_through =
    {
         r:Math.sqrt(Math.pow(expression.l, 2) /3) +expression.s *Math.cos(expression.h),
         g:Math.sqrt(Math.pow(expression.l, 2) /3) +expression.s *Math.cos(expression.h -((Math.PI *2) /3.0)),
         b:Math.sqrt(Math.pow(expression.l, 2) /3) +expression.s *Math.cos(expression.h +((Math.PI *2) /3.0))
    };
};
...
const test = () =>
{
    ...
    console.log("hslToRgb(rgbToHsl({r:0.0,g:0.0,b:0.0}))", hslToRgb(rgbToHsl({r:0.0,g:0.0,b:0.0})), rgbToHsl({r:0.0,g:0.0,b:0.0}).l, Math.sqrt(Math.pow(rgbToHsl({r:0.0,g:0.0,b:0.0}).l, 2) /3));
    console.log("hslToRgb(rgbToHsl({r:1.0,g:0.0,b:0.0}))", hslToRgb(rgbToHsl({r:1.0,g:0.0,b:0.0})), rgbToHsl({r:1.0,g:0.0,b:0.0}).l, Math.sqrt(Math.pow(rgbToHsl({r:1.0,g:0.0,b:0.0}).l, 2) /3));
    console.log("hslToRgb(rgbToHsl({r:1.0,g:1.0,b:0.0}))", hslToRgb(rgbToHsl({r:1.0,g:1.0,b:0.0})), rgbToHsl({r:1.0,g:1.0,b:0.0}).l, Math.sqrt(Math.pow(rgbToHsl({r:1.0,g:1.0,b:0.0}).l, 2) /3));
    console.log("hslToRgb(rgbToHsl({r:1.0,g:1.0,b:1.0}))", hslToRgb(rgbToHsl({r:1.0,g:1.0,b:1.0})), rgbToHsl({r:1.0,g:1.0,b:1.0}).l, Math.sqrt(Math.pow(rgbToHsl({r:1.0,g:1.0,b:1.0}).l, 2) /3));
    console.log("hslToRgb(rgbToHsl({r:0.5,g:0.5,b:0.5}))", hslToRgb(rgbToHsl({r:0.5,g:0.5,b:0.5})), rgbToHsl({r:0.5,g:0.5,b:0.5}).l, Math.sqrt(Math.pow(rgbToHsl({r:0.5,g:0.5,b:0.5}).l, 2) /3));
    console.log("hslToRgb(rgbToHsl({r:0.1,g:0.0,b:0.0}))", hslToRgb(rgbToHsl({r:0.1,g:0.0,b:0.0})), rgbToHsl({r:0.1,g:0.0,b:0.0}).l, Math.sqrt(Math.pow(rgbToHsl({r:0.1,g:0.0,b:0.0}).l, 2) /3));
    console.log("hslToRgb(rgbToHsl({r:0.1,g:0.1,b:0.0}))", hslToRgb(rgbToHsl({r:0.1,g:0.1,b:0.0})), rgbToHsl({r:0.1,g:0.1,b:0.0}).l, Math.sqrt(Math.pow(rgbToHsl({r:0.1,g:0.1,b:0.0}).l, 2) /3));
    console.log("hslToRgb(rgbToHsl({r:0.9,g:0.0,b:0.0}))", hslToRgb(rgbToHsl({r:0.9,g:0.0,b:0.0})), rgbToHsl({r:0.9,g:0.0,b:0.0}).l, Math.sqrt(Math.pow(rgbToHsl({r:0.9,g:0.0,b:0.0}).l, 2) /3));
    console.log("hslToRgb(rgbToHsl({r:0.9,g:0.9,b:0.0}))", hslToRgb(rgbToHsl({r:0.9,g:0.9,b:0.0})), rgbToHsl({r:0.9,g:0.9,b:0.0}).l, Math.sqrt(Math.pow(rgbToHsl({r:0.9,g:0.9,b:0.0}).l, 2) /3));
};
